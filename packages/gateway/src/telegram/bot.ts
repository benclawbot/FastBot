  ...
  private async registerCommands(): Promise<void> {
    try {
      await this.bot.api.setMyCommands([
        ...
        { command: "botstatus", description: "Bot process status" },
        ...
        { command: "model", description: "Show or set AI model" },
        ...
        { command: "softreset", description: "Reset conversation (keep session)" },
        { command: "sessions", description: "List recent sessions" },
        { command: "resume", description: "Resume a session" },
        { command: "continue", description: "Continue last session" },
        { command: "teleport", description: "Fork session to terminal" },
        { command: "file", description: "Download file from project" },
        { command: "telegraph", description: "View markdown file" },
